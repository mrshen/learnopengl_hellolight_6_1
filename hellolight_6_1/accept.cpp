...
int main()
{
	...
	myShader.setMaxtrix("projection", glm::value_ptr(projection));
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		myShader.setMaxtrix("view", glm::value_ptr(view));

		myShader.setVec3("objMaterial.ambient", glm::vec3(1.f, .5f, .3f));
		myShader.setVec3("objMaterial.diffuse", glm::vec3(1.f, .5f, .3f));
		myShader.setVec3("objMaterial.specular", glm::vec3(1.f, 1.f, 1.f));
		myShader.setFloat("objMaterial.shinness", 64.0f);

		glm::vec3 lightColor;
		lightColor.x = sin(glfwGetTime() * 2.0f);
		lightColor.y = sin(glfwGetTime() * 0.7f);
		lightColor.z = sin(glfwGetTime() * 1.3f);
		myShader.setVec3("lightPos", glm::vec3(0.f, 10.f, -5.f));
		myShader.setVec3("lightColor", lightColor);
		myShader.setVec3("camPos", cam.getCamPosition());
